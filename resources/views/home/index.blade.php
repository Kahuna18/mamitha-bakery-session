...
@section('content')
{{-- HERO SECTION --}}
<section class="relative bg-gradient-to-br from-amber-50 via-cream-50 to-orange-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 overflow-hidden transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div class="grid md:grid-cols-2 gap-8 items-center">
            <div class="text-center md:text-left">
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-amber-900 dark:text-amber-400 leading-tight mb-4">
                    Roti Fresh Setiap Hari,<br>
                    <span class="text-amber-600 dark:text-amber-500">Bisa Pesan Mudah dari Rumah</span>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                    ...
                    <a href="{{ route('menu') }}" class="px-8 py-4 bg-white dark:bg-gray-800 hover:bg-amber-50 dark:hover:bg-gray-700 text-amber-700 dark:text-amber-400 font-semibold text-lg rounded-xl border-2 border-amber-200 dark:border-gray-700 shadow-sm transition text-center">
                        Lihat Menu
                    </a>
                </div>
            </div>
            <div class="relative hidden md:block">
                <div class="rounded-full w-96 h-96 mx-auto overflow-hidden shadow-xl border-4 border-white dark:border-gray-850">
                    <img src="{{ asset('images/logo.jpeg') }}" class="w-full h-full object-cover" alt="Mamitha Logo">
                </div>
                <div class="absolute -bottom-4 -left-4 bg-white dark:bg-gray-850 border border-amber-100 dark:border-gray-800 rounded-xl shadow-lg p-3">
                    <p class="text-sm font-semibold text-amber-800 dark:text-amber-400">Fresh Baked Daily</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-16 bg-white dark:bg-gray-900 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            <h2 class="text-3xl md:text-4xl font-bold text-amber-900 dark:text-amber-400 mb-3">Produk Unggulan Kami</h2>
            <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Pilihan roti dan kue terbaik yang paling disukai pelanggan</p>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-amber-100 dark:border-gray-700 overflow-hidden hover:shadow-md transition">
                ...
                <div class="p-3 md:p-4">
                    ...
                    <h3 class="font-semibold text-gray-800 dark:text-gray-100 mt-2 text-sm md:text-base">{{ $product->name }}</h3>
            ...
            @empty
            <p class="col-span-full text-center text-gray-500 dark:text-gray-400 py-8">Belum ada produk unggulan.</p>
            @endforelse
        </div>
    </div>
</section>
...
<section class="py-10 bg-white dark:bg-gray-900 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative overflow-hidden bg-gradient-to-br from-amber-800 via-amber-900 to-orange-950 rounded-[32px] p-8 md:p-12 shadow-xl border border-amber-700/20 dark:border-gray-700 hover:scale-[1.01] transition-all duration-300 group">
...
{{-- CARA PESAN --}}
<section class="py-16 bg-amber-50 dark:bg-gray-900/50 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            <h2 class="text-3xl md:text-4xl font-bold text-amber-900 dark:text-amber-400 mb-3">Cara Pesan</h2>
            <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Cukup 4 langkah mudah untuk menikmati roti fresh kami</p>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="text-center">
                <div class="w-20 h-20 mx-auto bg-amber-100 dark:bg-gray-800 border dark:border-gray-700 rounded-full flex items-center justify-center mb-4">
                ...
                <h3 class="font-semibold text-gray-800 dark:text-gray-200">Pilih Roti</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Lihat menu dan pilih roti favorit Anda</p>
            </div>
            <div class="text-center">
                <div class="w-20 h-20 mx-auto bg-amber-100 dark:bg-gray-800 border dark:border-gray-700 rounded-full flex items-center justify-center mb-4">
                    <span class="text-3xl">📝</span>
                ...
                <h3 class="font-semibold text-gray-800 dark:text-gray-200">Isi Data Pesanan</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Nama, nomor WA, dan alamat lengkap</p>
            </div>
            <div class="text-center">
                <div class="w-20 h-20 mx-auto bg-amber-100 dark:bg-gray-800 border dark:border-gray-700 rounded-full flex items-center justify-center mb-4">
                    <span class="text-3xl">✅</span>
                ...
                <h3 class="font-semibold text-gray-800 dark:text-gray-200">Konfirmasi Admin</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Admin akan konfirmasi via WhatsApp</p>
            </div>
            <div class="text-center">
                <div class="w-20 h-20 mx-auto bg-amber-100 dark:bg-gray-800 border dark:border-gray-700 rounded-full flex items-center justify-center mb-4">
                    <span class="text-3xl">🎂</span>
                ...
                <h3 class="font-semibold text-gray-800 dark:text-gray-200">Roti Diproses</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Roti dibuat fresh, siap diambil/diantar</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 bg-white dark:bg-gray-900 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            <h2 class="text-3xl md:text-4xl font-bold text-amber-900 dark:text-amber-400 mb-3">Apa Kata Pelanggan</h2>
        </div>
        <div class="grid md:grid-cols-3 gap-6">
            @forelse($testimonials as $t)
            <div class="bg-amber-50 dark:bg-gray-800 border dark:border-gray-700 rounded-xl p-6">
                <div class="flex items-center mb-3">
                    <div class="w-12 h-12 bg-amber-200 dark:bg-amber-900/50 dark:text-amber-200 rounded-full flex items-center justify-center text-xl select-none">{{ $t->avatar }}</div>
                    <div class="ml-3">
                ...
                <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">"{{ $t->body }}"</p>
            </div>
            @empty
            <p class="col-span-full text-center text-gray-500 dark:text-gray-400 py-8">Belum ada testimoni.</p>
            @endforelse
        </div>
    </div>
</section>
...
<section class="py-16 bg-amber-50 dark:bg-gray-900/50 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            <h2 class="text-3xl md:text-4xl font-bold text-amber-900 dark:text-amber-400 mb-3">Hubungi Kami</h2>
            <p class="text-gray-600 dark:text-gray-400">Senang mendengar dari Anda</p>
        </div>
        <div class="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border dark:border-gray-700">
                <div class="w-14 h-14 mx-auto bg-green-100 dark:bg-green-950/30 rounded-full flex items-center justify-center mb-3">
                    <svg class="w-7 h-7 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 448 512"><path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6z"/></svg>
                </div>
                <h3 class="font-semibold text-gray-800 dark:text-gray-200 mb-2">WhatsApp</h3>
                <p class="text-gray-600 dark:text-gray-300 text-sm">{{ $storePhone }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border dark:border-gray-700">
                <div class="w-14 h-14 mx-auto bg-amber-100 dark:bg-amber-950/30 rounded-full flex items-center justify-center mb-3">
                ...
                <h3 class="font-semibold text-gray-800 dark:text-gray-200 mb-2">Alamat Toko</h3>
                <p class="text-gray-600 dark:text-gray-300 text-sm">{{ $storeAddress }}</p>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border dark:border-gray-700">
                <div class="w-14 h-14 mx-auto bg-amber-100 dark:bg-amber-950/30 rounded-full flex items-center justify-center mb-3">
